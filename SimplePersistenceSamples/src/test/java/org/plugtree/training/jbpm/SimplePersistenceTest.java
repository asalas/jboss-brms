...
//        env.set("DOMAIN_EMF", domainEmf);
        ...
        ObjectMarshallingStrategy[] objectMarshallingStrategies = new ObjectMarshallingStrategy[]{
            new JPAPlaceholderResolverStrategy(env2),
            //new DomainMarshallingStrategy(env),
            new SerializablePlaceholderResolverStrategy(ClassObjectMarshallingStrategyAcceptor.DEFAULT)
        };
		env.set(EnvironmentName.OBJECT_MARSHALLING_STRATEGIES, objectMarshallingStrategies);
    ...
    private PoolingDataSource createDataSrouce() {
        ...
        ds1.getDriverProperties().put("URL", "jdbc:mysql://localhost/jbpm_orm");
        ds1.init();
