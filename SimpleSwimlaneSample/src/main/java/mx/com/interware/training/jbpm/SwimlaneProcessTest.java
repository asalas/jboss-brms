...
public class SwimlaneProcessTest extends BaseTest implements Serializable {
    ...
    public void setup() throws IOException{
        ...
        File logFile = File.createTempFile("process-output-swinlane", "");
        ...
        // Configurar WorkItemHandler para tareas humanas (Human Task)
    ...
    public void swimlaneProcessTest() throws InterruptedException{
        ...
        ProcessInstance process = ksession.startProcess("mx.com.interware.training.jbpm.swimlaneprocess");
