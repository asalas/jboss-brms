...
public class HumanTaskClient {
	...
	public HumanTaskClient() {
		MinaTaskClientHandler minaTaskClientHandler = new MinaTaskClientHandler(SystemEventListenerFactory.getSystemEventListener());
		MinaTaskClientConnector minaTaskClientConnector = new MinaTaskClientConnector("client 1", minaTaskClientHandler);
	...
	public void start() throws RuntimeException {
		...
		workItemManager.registerWorkItemHandler("Human Task", new WSHumanTaskHandler());
		workItemManager.registerWorkItemHandler("Report", new GenerateReportWorkItem());
	}
